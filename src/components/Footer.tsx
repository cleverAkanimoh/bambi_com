...
const Footer = () => {
    ...
    return (
        <footer className="mt-10 bg-secondary pt-20 md:pt-32 text-white">
            <div className="w-[90%] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-10 pb-14 md:pb-20">
                <div className="flex flex-col gap-4">
                    <h1 className="text-xl">About Us</h1>
                    <p >We create games that inspire growth and development, from
                    ...
                    <div className="flex gap-2 items-center">
                        <a title="Facebook" className="text-primary p-3 hover:text-white hover:bg-[#353535] text-center grid place-items-center rounded-full bg-white" href="#"><FaFacebookF  /></a>
                        <a title="Twitter" className="text-primary p-3 hover:text-white hover:bg-[#151515] text-center grid place-items-center rounded-full bg-white" href="#"><TiSocialTwitter  /></a>
                        <a title="LinkedIn" className="text-primary p-3 hover:text-white hover:bg-[#151515] text-center grid place-items-center rounded-full bg-white" href="#"><FaLinkedinIn  /></a>
                        <a title="Youtube" className="text-primary p-3 hover:text-white hover:bg-[#151515] text-center grid place-items-center rounded-full bg-white" href="#"><TfiYoutube  /></a>
                        <a title="Vimeo" className="text-primary p-3 hover:text-white hover:bg-[#151515] text-center grid place-items-center rounded-full bg-white" href="#"><FaVimeoV  /></a>
                ...
                <form className="flex flex-col gap-4">
                    <h2 className="text-xl">Sign Up for Newsletter</h2>
                    ...
                    <p>Join over 1,000 people who get free and fresh content
